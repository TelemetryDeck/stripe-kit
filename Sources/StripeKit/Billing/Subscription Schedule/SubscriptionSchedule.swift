...
public struct SubscriptionScheduleDefaultSettings: Codable, Sendable {
...
public struct SubscriptionScheduleDefaultSettingsAutomaticTax: Codable, Sendable {
...
public enum SubscriptionScheduleCollectionMethod: String, Codable, Sendable {
...
public struct SubscriptionScheduleDefaultSettingsBillingThresholds: Codable, Sendable {
...
public struct SubscriptionScheduleInvoiceSettings: Codable, Sendable {
...
public struct SubscriptionScheduleTransferData: Codable, Sendable {
...
public struct SubscriptionSchedulePhase: Codable, Sendable {
...
public struct SubscriptionSchedulePhaseAddInvoiceItem: Codable, Sendable {
...
public struct SubscriptionSchedulePhaseAutomaticTax: Codable, Sendable {
    /// Whether Stripe automatically computes tax on invoices created during this phase.
    public var enabled: Bool?
...
public struct SubscriptionSchedulePhaseItem: Codable, Sendable {
...
public struct SubscriptionSchedulePhaseItemBillingThresholds: Codable, Sendable {
...
public struct SubscriptionSchedulePhaseTransferData: Codable, Sendable {
    /// A non-negative decimal between 0 and 100, with at most two decimal places. This represents the percentage of the subscription invoice subtotal that will be transferred to the destination account. By default, the entire amount is transferred to the destination.
    public var amountPercent: Int?
    /// The account where funds from the payment will be transferred to upon payment success.
    @Expandable<ConnectAccount> public var destination: String?
...
public enum SubscriptionScheduleBillingCycleAnchor: String, Codable, Sendable {
...
public enum SubscriptionSchedulePhaseProrationBehavior: String, Codable, Sendable {
